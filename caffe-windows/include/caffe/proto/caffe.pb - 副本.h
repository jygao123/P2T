...
enum V1LayerParameter_LayerType {
  ...
  V1LayerParameter_LayerType_TRACKING_LOSS = 40,
...
const V1LayerParameter_LayerType V1LayerParameter_LayerType_LayerType_MAX = V1LayerParameter_LayerType_TRACKING_LOSS;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.TrackingLossParameter tracking_loss_param = 146;
  inline bool has_tracking_loss_param() const;
  inline void clear_tracking_loss_param();
  static const int kTrackingLossParamFieldNumber = 146;
  inline const ::caffe::TrackingLossParameter& tracking_loss_param() const;
  inline ::caffe::TrackingLossParameter* mutable_tracking_loss_param();
  inline ::caffe::TrackingLossParameter* release_tracking_loss_param();
  inline void set_allocated_tracking_loss_param(::caffe::TrackingLossParameter* tracking_loss_param);
 ...
 private:
  ...
  inline void set_has_tracking_loss_param();
  inline void clear_has_tracking_loss_param();
  ...
  ::caffe::TrackingLossParameter* tracking_loss_param_;
...
class TrackingLossParameter : public ::google::protobuf::Message {
 public:
  TrackingLossParameter();
  virtual ~TrackingLossParameter();

  TrackingLossParameter(const TrackingLossParameter& from);

  inline TrackingLossParameter& operator=(const TrackingLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const TrackingLossParameter& default_instance();

  void Swap(TrackingLossParameter* other);

  // implements Message ----------------------------------------------

  TrackingLossParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const TrackingLossParameter& from);
  void MergeFrom(const TrackingLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional float lambda1 = 3 [default = 1];
  inline bool has_lambda1() const;
  inline void clear_lambda1();
  static const int kLambda1FieldNumber = 3;
  inline float lambda1() const;
  inline void set_lambda1(float value);

  // @@protoc_insertion_point(class_scope:caffe.TrackingLossParameter)
 private:
  inline void set_has_margin();
  inline void clear_has_margin();
  inline void set_has_legacy_version();
  ...
  void InitAsDefaultInstance();
  static TrackingLossParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class V1LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType TRACKING_LOSS = V1LayerParameter_LayerType_TRACKING_LOSS;
  ...
  // optional .caffe.TrackingLossParameter tracking_loss_param = 43;
  inline bool has_tracking_loss_param() const;
  inline void clear_tracking_loss_param();
  static const int kTrackingLossParamFieldNumber = 43;
  inline const ::caffe::TrackingLossParameter& tracking_loss_param() const;
  inline ::caffe::TrackingLossParameter* mutable_tracking_loss_param();
  inline ::caffe::TrackingLossParameter* release_tracking_loss_param();
  inline void set_allocated_tracking_loss_param(::caffe::TrackingLossParameter* tracking_loss_param);
...
// optional .caffe.TrackingLossParameter tracking_loss_param = 146;
inline bool LayerParameter::has_tracking_loss_param() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
inline void LayerParameter::set_has_tracking_loss_param() {
  _has_bits_[0] |= 0x00080000u;
}
inline void LayerParameter::clear_has_tracking_loss_param() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void LayerParameter::clear_tracking_loss_param() {
  if (tracking_loss_param_ != NULL) tracking_loss_param_->::caffe::TrackingLossParameter::Clear();
  clear_has_tracking_loss_param();
}
inline const ::caffe::TrackingLossParameter& LayerParameter::tracking_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.tracking_loss_param)
  return tracking_loss_param_ != NULL ? *tracking_loss_param_ : *default_instance_->tracking_loss_param_;
}
inline ::caffe::TrackingLossParameter* LayerParameter::mutable_tracking_loss_param() {
  set_has_tracking_loss_param();
  if (tracking_loss_param_ == NULL) tracking_loss_param_ = new ::caffe::TrackingLossParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.tracking_loss_param)
  return tracking_loss_param_;
}
inline ::caffe::TrackingLossParameter* LayerParameter::release_tracking_loss_param() {
  clear_has_tracking_loss_param();
  ::caffe::TrackingLossParameter* temp = tracking_loss_param_;
  tracking_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_tracking_loss_param(::caffe::TrackingLossParameter* tracking_loss_param) {
  delete tracking_loss_param_;
  tracking_loss_param_ = tracking_loss_param;
  if (tracking_loss_param) {
    set_has_tracking_loss_param();
  } else {
    clear_has_tracking_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.tracking_loss_param)
}
...
// optional float margin = 1 [default = 1];
inline bool TrackingLossParameter::has_margin() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void TrackingLossParameter::set_has_margin() {
  _has_bits_[0] |= 0x00000001u;
}
inline void TrackingLossParameter::clear_has_margin() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void TrackingLossParameter::clear_margin() {
  margin_ = 1;
  clear_has_margin();
}
inline float TrackingLossParameter::margin() const {
  // @@protoc_insertion_point(field_get:caffe.TrackingLossParameter.margin)
  return margin_;
}
inline void TrackingLossParameter::set_margin(float value) {
  set_has_margin();
  margin_ = value;
  // @@protoc_insertion_point(field_set:caffe.TrackingLossParameter.margin)
}

// optional bool legacy_version = 2 [default = false];
inline bool TrackingLossParameter::has_legacy_version() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void TrackingLossParameter::set_has_legacy_version() {
  _has_bits_[0] |= 0x00000002u;
}
inline void TrackingLossParameter::clear_has_legacy_version() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void TrackingLossParameter::clear_legacy_version() {
  legacy_version_ = false;
  clear_has_legacy_version();
}
inline bool TrackingLossParameter::legacy_version() const {
  // @@protoc_insertion_point(field_get:caffe.TrackingLossParameter.legacy_version)
  return legacy_version_;
}
inline void TrackingLossParameter::set_legacy_version(bool value) {
  set_has_legacy_version();
  legacy_version_ = value;
  // @@protoc_insertion_point(field_set:caffe.TrackingLossParameter.legacy_version)
}

// optional float lambda1 = 3 [default = 1];
inline bool TrackingLossParameter::has_lambda1() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void TrackingLossParameter::set_has_lambda1() {
  _has_bits_[0] |= 0x00000004u;
}
inline void TrackingLossParameter::clear_has_lambda1() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void TrackingLossParameter::clear_lambda1() {
  lambda1_ = 1;
  clear_has_lambda1();
}
inline float TrackingLossParameter::lambda1() const {
  // @@protoc_insertion_point(field_get:caffe.TrackingLossParameter.lambda1)
  return lambda1_;
}
inline void TrackingLossParameter::set_lambda1(float value) {
  set_has_lambda1();
  lambda1_ = value;
  // @@protoc_insertion_point(field_set:caffe.TrackingLossParameter.lambda1)
}
...
// optional .caffe.TrackingLossParameter tracking_loss_param = 43;
inline bool V1LayerParameter::has_tracking_loss_param() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void V1LayerParameter::set_has_tracking_loss_param() {
  _has_bits_[0] |= 0x00010000u;
}
inline void V1LayerParameter::clear_has_tracking_loss_param() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void V1LayerParameter::clear_tracking_loss_param() {
  if (tracking_loss_param_ != NULL) tracking_loss_param_->::caffe::TrackingLossParameter::Clear();
  clear_has_tracking_loss_param();
}
inline const ::caffe::TrackingLossParameter& V1LayerParameter::tracking_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.V1LayerParameter.tracking_loss_param)
  return tracking_loss_param_ != NULL ? *tracking_loss_param_ : *default_instance_->tracking_loss_param_;
}
inline ::caffe::TrackingLossParameter* V1LayerParameter::mutable_tracking_loss_param() {
  set_has_tracking_loss_param();
  if (tracking_loss_param_ == NULL) tracking_loss_param_ = new ::caffe::TrackingLossParameter;
  // @@protoc_insertion_point(field_mutable:caffe.V1LayerParameter.tracking_loss_param)
  return tracking_loss_param_;
}
inline ::caffe::TrackingLossParameter* V1LayerParameter::release_tracking_loss_param() {
  clear_has_tracking_loss_param();
  ::caffe::TrackingLossParameter* temp = tracking_loss_param_;
  tracking_loss_param_ = NULL;
  return temp;
}
inline void V1LayerParameter::set_allocated_tracking_loss_param(::caffe::TrackingLossParameter* tracking_loss_param) {
  delete tracking_loss_param_;
  tracking_loss_param_ = tracking_loss_param;
  if (tracking_loss_param) {
    set_has_tracking_loss_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.V1LayerParameter.tracking_loss_param)
}
